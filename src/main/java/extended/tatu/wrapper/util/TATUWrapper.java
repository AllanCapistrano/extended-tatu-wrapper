...
public final class TATUWrapper {
  ...
  public static String buildTATUFlowInfoMessage(
    String sensorId,
    int collectSeconds,
    int publishSeconds
  ) {
  ...
  public static String buildTATUFlowValueMessage(
    String sensorId,
    int collectSeconds,
    int publishSeconds
  ) {
  ...
  private static String buildTATUFlow(
    String sensorId,
    int collectSeconds,
    int publishSeconds,
    String command
  ...
  public static String buildTATUTopic(String deviceName) {
    return new StringBuilder().append(TOPIC_BASE).append(deviceName).toString();
  }
  ...
  public static String buildGetMessageResponse(
    String deviceName,
    String deviceConduct,
    String sensorName,
    Object value
  ) {
    ...
    body.put("CONDUCT", deviceConduct);
  ...
  public static String buildFlowMessageResponse(
    String deviceName,
    String sensorName,
    int publish,
    int collect,
  ...
  public static boolean isTATUResponse(String message) {
    return isValidMessage(message) && isValidTATUAnswer(message);
  }
  ...
  public static boolean isValidTATUAnswer(String answer) {
    try {
      ...
      return (
        (json.get("CODE").toString().contentEquals("POST")) &&
